...
\vspace*{-.1in}
  ...
  %put this some where
  %As a safety precaution the plane will feature a separate processor that will over ride the programming to allow for manuel control of the airplane.
  
  %paragraph about the arduino
...
\begin{itemize}
\item 3-4 weeks research.
\item 2-3 weeks fix broken plane.
\item 2-4 weeks send plane up in remote control with sensors to gather data and understanding.
